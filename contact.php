...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
         ...
         <input type="number" min="0" max="9999999999" placeholder="Masukan nomor anda" required maxlength="10" name="number" class="box">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>No Telepon</h3>
         <a href="tel:0856">0856-6543-2341</a>
      </div>

      <div class="box">
         <i class="fas fa-envelope"></i>
         <h3>Alamat Email</h3>
         <a href="mailto:firmansyah@gmail.com">firmansyah@gmail.come</a>
      </div>

      <div class="box">
         <i class="fas fa-map-marker-alt"></i>
         <h3>Alamat Lengkap</h3>
         <a href="#">Kab. Brebes Kec. Songgom</a>
      </div>
