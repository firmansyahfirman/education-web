...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data" class="login">
      ...
      <input type="email" name="email" placeholder="Masukan email kamu" maxlength="50" required class="box">
      ...
      <p class="link">Tidak punya akun? <a href="register.php">Daftar Sekarang</a></p>
